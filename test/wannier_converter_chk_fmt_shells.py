...
#              wannier_converter_chk_fmt_shells.py
#
# Output files: wannier_converter_chk_fmt_shells.output.h5
#
# Command: pytriqs wannier_converter_chk_fmt_shells.py
#
# Description:
...
# wannier_converter_SrVO3_hr.dat is one of the output files of Wannier90. wannier_converter_SrVO3_hr.dat stores a real
# representation of the  local Hamiltonian expressed in MLWFs for SrVO3 with t2g states taken into account.
# Basing on read data, shells, correlated shells and projections (U matrices)  are constructed for SrVO3.
#
...
# removes wannier_converter_SrVO3.h5 if it exists
...
# reads wannier_converter_SrVO3_hr.dat, adds sort to shells, evaluates correlated shells
converter._h_to_triqs()

# reads  wannier_converter_SrVO3.chk.fmt and constructs projections
converter._produce_projections()

ar = HDFArchive('wannier_converter_chk_fmt_shells.output.h5', 'w')
