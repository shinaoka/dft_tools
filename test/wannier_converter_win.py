...
#
#    Input files: LaTiO3.win, wannier_converter_win.py
#
#    Output files: wannier_converter_win.output.h5
#
#    Command: pytriqs wannier_converter_win.py
#
#    Description:
...
# extract converter attributes
converter_attr = {"SO": converter.SO,
                  "SP": converter.SP,
                  "ham_nkpt": converter.ham_nkpt,
                  "shells": converter.shells,  # sort calculated in other benchmark!
                  "total_MLWF": converter.total_MLWF,
                  "total_Bloch": converter.total_Bloch,
                  "chemical_potential": converter.chemical_potential,
		          "cell_cart": converter._cell_cart
}

ar = HDFArchive('wannier_converter_win.output.h5', 'w')
ar["win_par"] = converter._win_par
ar["converter_attr"] = converter_attr
del ar

# win_par={  'spinors': 'false',
#            'hr_plot': 'true',
#            'fermi_energy': '15.3695',
#            'num_wann': '48',
#            'unit_cell_cart': 'Bohr\n
#                               10.443000 0.000 0.000\n
#                                0.000 \t10.6184424000000  0.000\n
#                                0.000 0.000 14.8708320000000', 
#            'num_bands': '76',
#            'mp_grid': '9 9 6',
...
#                          {'dim': 3, 'l': 1, 'atom': 15}],
#                "total_MLWF": 48,
#                "cell_cart': array([[ 5.52619761,  0.        ,  0.        ],
#                                    [ 0.        ,  5.61903773,  0.        ],
#                                    [ 0.        ,  0.        ,  7.8693054 ]])
#                "total_Bloch": 76,
