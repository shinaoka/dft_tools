...
from pytriqs.operators.util import U_matrix_kanamori, h_int_density
from pytriqs.archive import HDFArchive
from pytriqs.applications.impurity_solvers.cthyb import Solver
from pytriqs.gf.local import inverse, delta
...
This template is the slightly modified version of dft_dmft_cthyb.py from core SumkDFT.
...
for iteration_number in range(1+previous_runs,loops+1+previous_runs):
