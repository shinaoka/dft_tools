...
#
# Input files: wannier_converter_SrVO3.win, wannier_converter_SrVO3_hr.dat, wannier_converter_SrVO3.chk.fmt, wannier_converter_dft_dmft_cthyb_extract_G_loc.py
#
# Outputfiles: wannier_converter_dft_dmft_cthyb_extract_G_loc.output.h5
#
# Command: pytriqs wannier_converter_dft_dmft_cthyb_extract_G_loc.py
#
# Descriprion:
# Wannier converter prepares input for SumkDFT. For the purpose of this benchmark the value of chemical
# potential is known a priori. Within this benchamrk initial value of Weiss field for impurity solver is evaluated
# (in case of SrVO3 only one impurity problem has to be solved).
# .
# Tested features  within this benchmark:
#
#     * It is verified if initial Weiss field (non-interacting Green's function for the 1st inequivalent correlated shell)
...
h_field = 0.0
chemical_potential=12.469424 # to speed up a benchmark search for mu is skipped and the final value is provided
beta=40.0
